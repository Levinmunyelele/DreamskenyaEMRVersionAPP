...
export class RegistrationPage implements OnInit {
  ...
  questions = [
    ...
    },
    {
      ...
      type: 'radio',
      options: [
        { value: '589b6de3-b25a-4d42-a7a1-7e31afb1397c', label: 'Male' },
        { value: '6ff6baeb-d660-474e-a77e-4f11adf7bf02', label: 'Female' },
      ]
    },
    {
      label: 'Date of Birth',
      ...
      this.encounterService.getIdentifier(requestBody).subscribe(response => {
        ...
        if (generatedIdentifier) {
              ...
              names: [
                {
                  ...
                  // middleName: formData['Middle Name(Optional)'],
          ...
          this.encounterService.submitPatient(requestData).subscribe(
            (res) => console.log('Submission successful:', res),
            (err) => console.error('Error submitting data:', err)
          );
        } else {
