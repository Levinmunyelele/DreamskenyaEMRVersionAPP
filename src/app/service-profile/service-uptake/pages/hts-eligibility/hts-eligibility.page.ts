...
import { HtsEligibilityComponent } from 'src/app/service-profile/service-uptake/modals/hts-eligibility/hts-eligibility.component';
import { ActivatedRoute } from '@angular/router';
import { EncounterService } from 'src/app/services/encounter.service';
@Component({
  selector: 'app-hts-eligibility',
  templateUrl: './hts-eligibility.page.html',
  styleUrls: ['./hts-eligibility.page.scss'],
})
export class HtsEligibilityPage implements OnInit {
  ...
  async openModal(encounter?: any) { 
       ...
       component: HtsEligibilityComponent,
